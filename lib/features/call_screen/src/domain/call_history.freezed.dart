...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,callerId,callerName,callerAvatar,receiverId,receiverName,receiverAvatar,callType,status,direction,createdAt,duration,count);

@override
String toString() {
  return 'CallHistoryModel(id: $id, callerId: $callerId, callerName: $callerName, callerAvatar: $callerAvatar, receiverId: $receiverId, receiverName: $receiverName, receiverAvatar: $receiverAvatar, callType: $callType, status: $status, direction: $direction, createdAt: $createdAt, duration: $duration, count: $count)';
}
...
/// Create a copy of CallHistoryModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? callerId = freezed,Object? callerName = freezed,Object? callerAvatar = freezed,Object? receiverId = freezed,Object? receiverName = freezed,Object? receiverAvatar = freezed,Object? callType = null,Object? status = null,Object? direction = null,Object? createdAt = freezed,Object? duration = null,Object? count = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: '_id')  String id, @JsonKey(name: 'caller_id')  String? callerId, @JsonKey(name: 'caller_name')  String? callerName, @JsonKey(name: 'caller_avatar')  String? callerAvatar, @JsonKey(name: 'receiver_id')  String? receiverId, @JsonKey(name: 'receiver_name')  String? receiverName, @JsonKey(name: 'receiver_avatar')  String? receiverAvatar, @JsonKey(name: 'call_type')  String callType, @JsonKey(name: 'status')  String status, @JsonKey(name: 'direction')  String direction, @JsonKey(name: 'created_at')  String? createdAt, @JsonKey(name: 'duration')  int duration, @JsonKey(name: 'count')  int count)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CallHistoryModel() when $default != null:
return $default(_that.id,_that.callerId,_that.callerName,_that.callerAvatar,_that.receiverId,_that.receiverName,_that.receiverAvatar,_that.callType,_that.status,_that.direction,_that.createdAt,_that.duration,_that.count);case _:
  return orElse();
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: '_id')  String id, @JsonKey(name: 'caller_id')  String? callerId, @JsonKey(name: 'caller_name')  String? callerName, @JsonKey(name: 'caller_avatar')  String? callerAvatar, @JsonKey(name: 'receiver_id')  String? receiverId, @JsonKey(name: 'receiver_name')  String? receiverName, @JsonKey(name: 'receiver_avatar')  String? receiverAvatar, @JsonKey(name: 'call_type')  String callType, @JsonKey(name: 'status')  String status, @JsonKey(name: 'direction')  String direction, @JsonKey(name: 'created_at')  String? createdAt, @JsonKey(name: 'duration')  int duration, @JsonKey(name: 'count')  int count)?  $default,) {final _that = this;
switch (_that) {
case _CallHistoryModel() when $default != null:
return $default(_that.id,_that.callerId,_that.callerName,_that.callerAvatar,_that.receiverId,_that.receiverName,_that.receiverAvatar,_that.callType,_that.status,_that.direction,_that.createdAt,_that.duration,_that.count);case _:
  return null;
...
/// Create a copy of CallHistoryModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? callerId = freezed,Object? callerName = freezed,Object? callerAvatar = freezed,Object? receiverId = freezed,Object? receiverName = freezed,Object? receiverAvatar = freezed,Object? callType = null,Object? status = null,Object? direction = null,Object? createdAt = freezed,Object? duration = null,Object? count = null,}) {
