...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DashboardModel&&(identical(other.id, id) || other.id == id));
}
...
class _DashboardModel implements DashboardModel {
  const _DashboardModel({required this.id});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DashboardModel&&(identical(other.id, id) || other.id == id));
}
