...
mixin _$ChatModel {
 ...
 String get id;@JsonKey(name: 'is_group') bool get isGroup;@JsonKey(name: 'group_name') String? get groupName;@JsonKey(name: 'group_description') String? get groupDescription;@JsonKey(name: 'created_at') String get createdAt;@JsonKey(name: 'updated_at') String get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,isGroup,groupName,groupDescription,createdAt,updatedAt);

@override
String toString() {
  return 'ChatModel(id: $id, isGroup: $isGroup, groupName: $groupName, groupDescription: $groupDescription, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'is_group') bool isGroup,@JsonKey(name: 'group_name') String? groupName,@JsonKey(name: 'group_description') String? groupDescription,@JsonKey(name: 'created_at') String createdAt,@JsonKey(name: 'updated_at') String updatedAt
});
...
/// Create a copy of ChatModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? isGroup = null,Object? groupName = freezed,Object? groupDescription = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
...
switch (_that) {
case _ChatModel() when $default != null:
return $default(_that.id,_that.isGroup,_that.groupName,_that.groupDescription,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
class _ChatModel implements ChatModel {
  const _ChatModel({required this.id, @JsonKey(name: 'is_group') required this.isGroup, @JsonKey(name: 'group_name') this.groupName, @JsonKey(name: 'group_description') this.groupDescription, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'updated_at') required this.updatedAt});
...
/// Create a copy of ChatModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? isGroup = null,Object? groupName = freezed,Object? groupDescription = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
